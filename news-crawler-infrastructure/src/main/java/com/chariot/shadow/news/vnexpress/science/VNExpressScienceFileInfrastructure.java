...
public class VNExpressScienceFileInfrastructure extends FileInfrastructure {

    public VNExpressScienceFileInfrastructure(String directoryPrefix) {
    ...
    protected void fetchData(File entryDir, URL link) throws NewsRetrieverException, IOException {
        ...
        Element content = doc.select(".content_detail.fck_detail.width_common").first();
